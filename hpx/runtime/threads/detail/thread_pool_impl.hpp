...
namespace detail
{
    ...
    public:
        ...
        {
            LOG_ERROR_MSG("Creating pool with thread offset " << decnumber(thread_offset_));
        ...
        {
            LOG_ERROR_MSG("get_pu_num " << decnumber(num_thread));
...

            {
                ...
                try {
                    try {
                        ...
                        LOG_ERROR_MSG("Starting scheduling loop on local thread "
                                      << decnumber(global_thread_num - thread_offset_))
